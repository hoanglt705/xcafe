...
public class DayCompleteContentPanel extends JPanel {
  ...
  public DayCompleteContentPanel(DayPanel owner) {
    this.owner = owner;
    setOpaque(false);
    setBorder(BorderFactory.createLineBorder(owner.getCalendar().getConfig().getLineColor()));

    this.addMouseListener(new MouseAdapter() {

      @Override
      public void mouseClicked(final MouseEvent e) {
        for (MouseListener ml : DayCompleteContentPanel.this.owner.getCalendar().getMouseListeners()) {
          ml.mouseClicked(e);
        }
      }
      ...
      public void mousePressed(final MouseEvent e) {
        ...
        final JCalendar calendar = DayCompleteContentPanel.this.owner.getCalendar();

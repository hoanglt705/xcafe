...
public class CalendarUtil {
  ...
  public static int secondsToPixels(final Date date, final int maxHeight) {
    return secondsToPixels(getTotalSeconds(date), maxHeight);
  }

  public static int secondsToPixels(final long seconds, final int maxHeight) {
  ...
  public static Map<CalendarEvent, List<CalendarEvent>> getConflicting(
          final Collection<CalendarEvent> calendarEvents) {

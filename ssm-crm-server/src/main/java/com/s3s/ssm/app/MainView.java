...
public class MainView extends FrameView {
  ...
  private JXLoginPane.Status login() {
    ...
    JXLoginDialog loginDialog = new JXLoginDialog(getFrame(), panel);
  ...
  private class VLoginService extends LoginService {
    ...
    public boolean authenticate(String username, char[] password, String server) {
      boolean exits = CrmContextProvider.getInstance().getSecurityUserService()
  ...
  private void initStatusBar() {
    ...
    statusBar.add(new JSeparator(SwingConstants.VERTICAL), ct);
    JLabel lblUser = new JLabel("Tai khoan: " + currentUserName);

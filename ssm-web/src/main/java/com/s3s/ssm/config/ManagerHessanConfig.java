...
import com.s3s.ssm.service.IAclService;
...
public class ManagerHessanConfig {
  ...
  public HessianProxyFactoryBean hessianAclProxyFactoryBean() {
    HessianProxyFactoryBean bean = new HessianProxyFactoryBean();
    bean.setServiceUrl(SERVER_URL + "/AclService");
    bean.setServiceInterface(IAclService.class);
    return bean;
  }

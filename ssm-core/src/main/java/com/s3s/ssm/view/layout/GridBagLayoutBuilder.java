...
public class GridBagLayoutBuilder implements LayoutBuilder {
   ...
   * @return "this" to make it easier to string together append calls
   */
  public GridBagLayoutBuilder append(Component component, int x, int y, int colSpan, int rowSpan,
          boolean expandX,
  ...
  protected JLabel createLabel(String propertyName) {
    ...
    return new JLabel(propertyName);
  }
  ...
  private void insertPlaceholdersIfNeeded(final int rowSpan, final int y, final int col,
  ...
  /**
   * Appends a right-justified label to the end of the given line, using the provided string as the key to
   * look in the {@link #setComponentFactory(ComponentFactory) ComponentFactory's}message bundle for the text
   * to use.
   * 
   * @param labelKey
  ...
  /**
   * Appends a left-justified label to the end of the given line, using the provided string as the key to look
   * in the {@link #setComponentFactory(ComponentFactory) ComponentFactory's}message bundle for the text to
   * use.
   * 
   * @param labelKey
   *          the key into the message bundle; if not found the key is used as the text to display
  ...
  /**
   * Appends the given component to the end of the current line. The component will "grow" horizontally as
   * space
   * allows.
   * 
   * @param component
   ...
   * {@link #setComponentFactory(ComponentFactory) ComponentFactory's}message bundle for the text to put along
   * with
  ...
  /**
   * Creates and returns a JPanel with all the given components in it, using the "hints" that were provided to
   * the
   * builder.
   * 
  ...
  public JPanel getPanel() {
    ...
    // final JPanel panel = this.showGuidelines ? new GridBagLayoutDebugPanel() : new JPanel(new
    // GridBagLayout());
